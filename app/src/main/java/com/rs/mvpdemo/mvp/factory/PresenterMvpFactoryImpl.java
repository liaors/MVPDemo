...
public class PresenterMvpFactoryImpl<V, P extends BasePresenter<V>> implements PresenterMvpFactory<V, P> {
     ...
     * @return 工厂类
     */
    public static <V, P extends BasePresenter<V>> PresenterMvpFactoryImpl<V,P> createFactory(Class<?> viewClazz){
